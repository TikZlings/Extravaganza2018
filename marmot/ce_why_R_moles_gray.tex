...
\usetikzlibrary{patterns,3d,shapes.callouts,calc,backgrounds}
...
\foreach \n [count=\X] in {0,0.1,...,4}{\begin{tikzpicture}
\clip (-16,-4) rectangle (16,16);
\begin{scope}[tdplot_main_coords,scale=4]
...
\end{scope}
\end{scope}
\ifnum\X>10 % from https://tex.stackexchange.com/a/218029/121799
%\clip (-5,4) rectangle (5,10);
\foreach \i in {1,...,10}
