...
\shade[inner color=cyan, outer color=blue!50!cyan!80!black] (0,0) circle (\Radius);
\begin{scope}[transform shape nonlinear=true]
\pgftransformnonlinear{\spheretransformation}
\coati[scale=2.5,xshift=\X*1cm,yshift=-1.2cm];
\end{scope}
\shade[ball color=cyan,opacity=0.3] (0,0) circle (\Radius);
